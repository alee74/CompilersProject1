 ...
 * Methods appear in the same order as they do in scanner.h			 *
 * with the exception of Token's print function, which is			 *
...
// allows external access to private member line.
int Scanner::line() {
	return ln;
}


// allows external access to private member pos.
